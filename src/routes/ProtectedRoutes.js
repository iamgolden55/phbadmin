...
import HealthcareFinance from "../dashboard/HealthcareFinance";
...
import HospitalManagement from "../dashboard/HospitalManagement";
import HospitalRegistry from "../dashboard/HospitalRegistry";
...
import HospitalAdminContacts from "../pages/HospitalAdminContacts";
...
import PracticePagesList from "../pages/registry/PracticePagesList";
import PracticePageDetail from "../pages/registry/PracticePageDetail";

// Admin Pages
import UserManagement from "../pages/admin/UserManagement";
import PharmacyAccessLog from "../pages/admin/PharmacyAccessLog";

const protectedRoutes = [
  { path: "/", element: <PlatformOverview /> },
  { path: "dashboard/finance", element: <HealthcareFinance /> },
  { path: "dashboard/finance-original", element: <FinanceMonitoring /> },
  { path: "dashboard/events", element: <EventManagement /> },
  { path: "dashboard/sales", element: <SalesMonitoring /> },
  { path: "dashboard/analytics", element: <PlatformOverview /> },
  ...
  { path: "dashboard/hospital", element: <HospitalManagement /> },
  { path: "dashboard/hospital-registry", element: <HospitalRegistry /> },

  // Registry Routes
  { path: "registry/applications", element: <ApplicationsList /> },
  { path: "registry/applications/:applicationId", element: <ApplicationDetail /> },
  { path: "registry/practice-pages", element: <PracticePagesList /> },
  { path: "registry/practice-pages/:pageId", element: <PracticePageDetail /> },

  // Admin Routes
  { path: "admin/users", element: <UserManagement /> },
  { path: "admin/pharmacy-access-logs", element: <PharmacyAccessLog /> },
  ...
  { path: "pages/people", element: <HospitalAdminContacts /> },
  { path: "pages/people-original", element: <People /> },
