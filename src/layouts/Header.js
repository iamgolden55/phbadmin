      ...
      <Dropdown className="dropdown-profile ms-3 ms-xl-4" align="end">
        ...
        <Dropdown.Menu className="mt-10-f">
          <div className="dropdown-menu-body">
            ...
            <h5 className="mb-1 text-dark fw-semibold">{user?.full_name || "Admin User"}</h5>
            <p className="fs-sm text-secondary">{role?.name || "Administrator"}</p>
            {role?.role_type && (
              <span className="badge bg-primary-subtle text-primary fs-xs mb-2">
            ...
            <nav className="nav">
              ...
              <Link to="/pages/settings"><i className="ri-user-settings-line"></i> Account Settings</Link>
            </nav>
            <hr />
            <nav className="nav">
              <Link to="/pages/faq"><i className="ri-question-line"></i> Help Center</Link>
